...
<head>
    ...
    <link rel="stylesheet" href="css/foundFormStyle.css?v=<?php echo time();?>">
...
<body>
        ...
        <div class="right-section">
            ...
            <div class="right-part">
                ...
                <div class="left-form p-3">
                    ...
                    <div>
                        <form action="handlers/foundFormHandle.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-item">
                                ...
                                <input type="text" placeholder="Address" name="address"  id="addressInput" class="textNonActive">
                            </div>  

                            <div class="form-item">
                                <label class=" px-4" >Image <i class="fas fa-upload"></i> </label>
    ...
    <script src="js/foundForm.js" ></script>
</body>
</html>